...
vector-length request resolution. It should consume the accepted M67
...
then produce a typed vector-length resolution value/stage. It must preserve
base-type behavior, leave vector alignment and backend uninit unresolved, and
