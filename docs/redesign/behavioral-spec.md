...
Milestone 72 is selected for human acceptance as exact array-initialization
helper-set completion IR. It should consume accepted M68/M70/M71
request-resolution values and the remaining exact M67
`value<backend>(uninit::array)` request, then package the complete first-slot
helper set into one typed aggregate for later declaration/array lowering.
Backend uninit remains a typed deferred backend-value request boundary; M72
must not translate it to backend text, create renderer-ready values, lower
...
| TSIL semantic/lowering parity: legacy TSIL grammar and compiler handle calls, intrinsics, variables, loops, generation-time conditions, casts, type/value metadata, and cleanup passes. | `frozen/tsl-gen/tsl_gen/tsil.lark`, `frozen/tsl-gen/tsl_gen/tsil_engine/compiler.py`, `frozen/tsl-gen/tsl_gen/tsil_engine/passes/*.py`, `tsldata/primitives/**.tsl` | `required-now` for selected intrinsic-compose, base-type, signedness branch-pruning, scalar size-byte value, selected scalar bit-width arithmetic, selected size-byte equality predicate, exact size-byte branch-chain pruning, opaque selected-body handoff, selected assignment-form recognition, selected assignment/direct-intrinsic body IR, selected body-envelope IR, accepted exact array-body slot-envelope slices, accepted M65 array-body envelope pipeline integration, accepted M66 exact array-initialization slot form IR, accepted M67 helper-request IR, accepted M68 base-type request resolution, accepted M69 stage-pipeline extraction, accepted M70 exact vector-length request resolution, accepted M71 exact vector-alignment request resolution, and selected M72 exact helper-set completion; `required-later` for full semantic TSIL | Typed-opaque lowering, direct parameter-add mini-lowering, M38 selected intrinsic-compose helper lowering, M41 generation-time lowering contract, M42 aligned primitive-attribute branch pruning, M43 base type query values, M48 signedness branch pruning, M51 exact plain-`else` signedness branch support, M52 concrete integer type/signedness expansion, M53 typed rule-source boundary, M54 catalog-derived rule wiring, M55 scalar size-byte value query, accepted M56 exact size-bytes-times-eight value arithmetic, accepted M57 exact size-byte equality predicate lowering, accepted M58 staged lowering contract, accepted M59 exact size-byte branch-chain pruning, accepted M60 opaque selected-body handoff, accepted M61 selected assignment-form recognition, accepted M62 unresolved selected assignment/direct-intrinsic body IR, accepted M63 backend-neutral selected-body envelope IR, accepted M64 exact array-body envelope slot assembly, accepted M65 pipeline integration for that envelope, accepted M66 first-slot form IR, accepted M67 helper-request IR, accepted M68 base-type request-resolution boundary, accepted M69 extracted stage-pipeline boundary, accepted M70 vector-length request-resolution boundary, accepted M71 vector-alignment request-resolution boundary, and selected M72 helper-set completion boundary | No semantic primitive calls, loops, variables, broad type/value queries, broad direct intrinsics, broad `intrin_compose` metadata, generalized plain `else` generation branches, broad vector/register metadata, general generation-value comparisons beyond the accepted M57 predicates, branch-chain pruning beyond the accepted M59 exact chain, broad generation-value arithmetic beyond the accepted M56 expression, skeleton recognition from raw body text, helper evaluation beyond the accepted M68 base-type request, accepted M70 vector-length request, accepted M71 vector-alignment request, and selected M72 helper-set completion, backend uninit translation, or branch/body parity beyond selected M60 handoff, M61 form-recognition metadata, accepted M62 unresolved body IR, accepted M63 singleton envelope IR, accepted M64 exact opaque slot envelope, accepted M65 pipeline wiring, accepted M66 exact first-slot form IR, accepted M67 helper-request IR, accepted M68 base-type request resolution, accepted M69 stage-pipeline extraction, and accepted M70 vector-length request resolution, accepted M71 vector-alignment request resolution, and selected M72 helper-set completion | M38 selected helper lowering, M40 translation/boundary correction, M41-M43 accepted lowering slices, M48 signedness pruning, M51 plain-`else` signedness branch slice, M52 concrete integer type/signedness slice, M53 rule-source boundary, M54 catalog-derived rule wiring, M55 scalar size-byte value query, accepted M56 value arithmetic, accepted M57 predicate lowering, accepted M58 stage boundary, accepted M59 branch-chain pruning, accepted M60 handoff, M61 assignment-form recognition, accepted M62 assignment/direct-intrinsic body IR, accepted M63 selected-body envelope IR, accepted M64 exact array-body slot envelope, accepted M65 array-body envelope pipeline integration, accepted M66 exact array-initialization slot form IR, accepted M67 helper-request IR, accepted M68 base-type request resolution, accepted M69 stage-pipeline extraction, accepted M70 vector-length request resolution, accepted M71 vector-alignment request resolution, and selected M72 helper-set completion | Unit lowering fixtures, unsupported-form diagnostics, deterministic lowered IR/stage outputs, selected-branch-only diagnostics, generation-value diagnostics, typed handoff/form-recognition/body-IR/envelope/slot-envelope/request/request-resolution diagnostics, pipeline integration and first-slot form/request-resolution tests, translation metadata tests, backend rejection of unresolved generation-time helpers, renderer non-evaluation |
