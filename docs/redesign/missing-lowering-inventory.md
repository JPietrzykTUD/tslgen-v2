...
- The clean restart M127-M156 line has accepted real TSIL payload intake,
  ...
  token streams. That path deliberately still does not render primitive-call
  expressions, parse raw arithmetic operators, parse broad TSIL
