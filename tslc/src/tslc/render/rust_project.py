...
def _rust_algorithm_module(
    ...
    parts = [
        ...
        "        mask_layout, parallelism, BinaryAggregateKernel, BinaryConsumeKernel, BinaryKernel,\n"
        ...
        "        MaskPopulationCount, SelectedLoad, VectorFor,\n"
        "    };\n"
    ...
    parts.append(assets.text(_RUST_ALGORITHM_WRAPPER_ASSET).rstrip())
