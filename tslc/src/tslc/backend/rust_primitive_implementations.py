"""Render Rust primitive implementation traits, impls, and policy mappings."""
...
from tslc.backend.checked_api import CheckedConditionPlan, public_call_requires_unsafe
...
class RustPrimitiveImplementationRenderer:
    """Own stateful rendering of Rust implementation-side primitive code."""
...
__all__ = ("RustPrimitiveImplementationRenderer",)
