...
iteration, predicate, count, selection/index, and transform now have focused
public headers; the five behavioral families also own matching private
detail-loop headers. Consume and aggregate remain in temporary public/detail
catchalls until their ordered layout slice moves them.
